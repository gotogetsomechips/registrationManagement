...
<div class="index-content">
    ...
    <br>
    <form action="OutmigrationServlet?action=add" method="post" onsubmit="return check()">
        <table class="index-content-table-add">
            <tr>
                <td width="12%">姓名：</td><td><input class="index-content-table-td-add" type="text" id="outmigrationName" name="outmigrationName" value=""/></td>
            </tr>
            <tr>
                <td width="12%">性别：</td>
                <td>
                    <input name="outmigrationSex" type="radio" value="男" checked="checked"/>&nbsp;&nbsp;&nbsp;男&nbsp;&nbsp;&nbsp;&nbsp;
                    <input name="outmigrationSex" type="radio" value="女"/>&nbsp;&nbsp;&nbsp;女&nbsp;&nbsp;&nbsp;&nbsp;
                </td>
            </tr>
            <tr>
                <td width="12%">迁出金额：</td><td><input class="index-content-table-td-add" type="text" id="outmigrationPrice" name="outmigrationPrice" value=""/></td>
            </tr>
            <tr>
                <td width="12%">缴费方式：</td><td><input class="index-content-table-td-add" type="text" id="outmigrationPayway" name="outmigrationPayway" value=""/></td>
            </tr>
            <tr>
                <td width="12%">收费人员：</td><td><input class="index-content-table-td-add" type="text" id="outmigrationHandler" name="outmigrationHandler" value=""/></td>
            </tr>
            <tr>
                <td width="12%">迁出时间：</td><td><input class="index-content-table-td-add" type="text" id="outmigrationTime" name="outmigrationTime" value=""/></td>
            </tr>
            <tr>
