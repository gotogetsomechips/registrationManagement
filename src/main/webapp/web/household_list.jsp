...
<div class="index-content">
    ...
    <div class="index-content-operation">
        ...
        <div class="index-content-operation-search">
            ...
            <input type="hidden" id="searchColumn" name="searchColumn" value="household_name"/>
    ...
    <c:if test="${not empty list}">
        <table class="table table-striped table-hover table-bordered">
            ...
            <tr class="index-content-table-th">
                <th class="name-sortable ${param.sortField == 'household_name' ? param.sortDirection : ''}" onclick="sortByName()">姓名</th>
                <th>性别</th>
                <th>电话</th>
                <th>所在区</th>
                <th>房屋号</th>
            ...
            <c:forEach items="${list}" var="vo">
                <tr class="index-content-table-td">
                    ...
                    <td>
                        ...
                        <button class="btn btn-grad btn-danger btn-sm" style="padding: 0px 1px;"
                                onclick="confirmDelete(${vo.id}, '${vo.householdName}')">删除</button>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
...
<script>
    ...
    function getFieldIndex(field) {
        ...
        for (var i = 0; i < headers.length; i++) {
            if ($(headers[i]).hasClass('name-sortable') && field === 'household_name') {
                return i;
            }
        }
        return 0;
