...
<div class="index-content">
    ...
    <br>
    <form action="HouseholdServlet?action=edit" method="post" onsubmit="return check()">
        <input type="hidden" id="id" name="id" value="${vo.id}"/><input type="hidden" id="createBy" name="createBy" value="${vo.createBy}"/>
        <table class="index-content-table-add">
            <tr>
                <td width="12%">姓名：</td><td><input class="index-content-table-td-add" type="text" id="householdName" name="householdName" value="张三"/></td>
            </tr>
            <tr>
                <td width="12%">性别：</td>
                <td>
                    <input name="householdSex" type="radio" value="男" ${vo.householdSex=='男'?'checked':''}/>&nbsp;&nbsp;&nbsp;男&nbsp;&nbsp;&nbsp;&nbsp;
                    <input name="householdSex" type="radio" value="女" ${vo.householdSex=='女'?'checked':''}/>&nbsp;&nbsp;&nbsp;女&nbsp;&nbsp;&nbsp;&nbsp;
                </td>
            </tr>
            <tr>
                <td width="12%">电话：</td><td><input class="index-content-table-td-add" type="text" id="householdPhone" name="householdPhone" value="17722222222"/></td>
            </tr>
            <tr>
                <td width="12%">所在区：</td><td><input class="index-content-table-td-add" type="text" id="householdArea" name="householdArea" value="河北"/></td>
            </tr>
            <tr>
                <td width="12%">房屋号：</td><td><input class="index-content-table-td-add" type="text" id="householdHouseno" name="householdHouseno" value="1"/></td>
            </tr>
            <tr>
                <td width="12%">单元：</td><td><input class="index-content-table-td-add" type="text" id="householdUnit" name="householdUnit" value="413"/></td>
            </tr>
            <tr>
                <td width="12%">户型：</td><td><input class="index-content-table-td-add" type="text" id="householdStyle" name="householdStyle" value="8"/></td>
            </tr>
        </table>
        <br>
        <br>
