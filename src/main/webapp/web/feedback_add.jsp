...
<div class="index-content">
    ...
    <br>
    <form action="FeedbackServlet?action=add" method="post" onsubmit="return check()">
        <table class="index-content-table-add">
            <tr>
                <td width="12%">反馈人：</td><td><input class="index-content-table-td-add" type="text" id="feedbackName" name="feedbackName" value=""/></td>
            </tr>
            <tr>
                <td width="12%">电话：</td><td><input class="index-content-table-td-add" type="text" id="feedbackPhone" name="feedbackPhone" value=""/></td>
            </tr>
            <tr>
                <td width="12%">标题：</td><td><input class="index-content-table-td-add" type="text" id="feedbackTitle" name="feedbackTitle" value=""/></td>
            </tr>
            <tr>
                <td width="12%">内容：</td><td><textarea id="feedbackText" name="feedbackText" style="width: 60%; height: 100px;padding: 0px 17px;" placeholder="请输入内容......"></textarea></td>
            </tr>
        </table>
        <br>
        <br>
